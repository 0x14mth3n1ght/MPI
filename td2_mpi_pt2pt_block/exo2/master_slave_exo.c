...
//indicateur type donnée à traiter

#define TAG_READY 1 //debut nouveau travail
#define TAG_END 2 //fin travail
#define TAG_DATA 3 //donnée
...
void run_slave(int slave_rank)
{
    ...
    do
    {
        ...
        MPI_Get_count(&status, MPI_INT, &nreal);
        data = (double*)malloc(nreal*sizeof(double));
        MPI_Recv(data, nreal, MPI_DOUBLE, MASTER_RANK, TAG_DATA, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
        }
